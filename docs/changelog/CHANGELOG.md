...
All notable changes to the DSA Learning Platform will be documented in this file.
...
- Common subfolders pattern for shared utilities
- Platform documentation (overview, features, architecture)
